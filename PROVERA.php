            ...
            <div class="main-wrapper">
                <div class="container main-wrapper-outer">
                    ...
                    function updateKatastar (set) {
                        ...
                        if (idOpstine !== '') {
                            jQuery.get('http://www.datainvestment.rs/wp-content/themes/Edu/assets/php/katastar.php?idOpstine=' + idOpstine + '&izvor=' + izvor, function (data) {
                                try {
                                ...
                                var str = '<option value="">Izaberite katastarsku opštinu</option>';
                    ...
                    function validate () {
                        ...
                        if (jQuery('#vrstanepokretnosti').val() == null) {
                            ok = false;
                        }
