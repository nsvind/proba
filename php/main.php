...
<style>
		...
		<link rel='shortlink' href='http://www.datainvestment.rs/?p=876' />
		<link rel="alternate" type="application/json+oembed" href="http://www.datainvestment.rs/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.datainvestment.rs%2Fdelatnosti%2Fprocena-vrednosti-i-strukture-kapitala-preduzeca%2F" />
		<link rel="alternate" type="text/xml+oembed" href="http://www.datainvestment.rs/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.datainvestment.rs%2Fdelatnosti%2Fprocena-vrednosti-i-strukture-kapitala-preduzeca%2F&#038;format=xml" />
	<style>
			body {
				font-family: 'Arial'; 
                font-style: normal;
		...
		body { 
			background: #ffffff url(http://www.datainvestment.rs/wp-content/uploads/2014/06/bodybg.jpg)  top left  repeat scroll;  ; 
		} 
		
		#megaMenu #menuMobile .no-megamenu ul, #megaMenu #megaST .no-megamenu ul, .header-wrapper, .main-nav-outer-wrapper .slideMenu .menu ul, #primary-nav-mobile-id > li > ul.sub-menu, #megaMenu #megaST li.menu-item-depth-0 .nav-dd, body .st-cart-icon .cart-content .widget_shopping_cart_content, #megaMenu #menuMobile .nav-dd { background: #f7f7f7;  ; }	
